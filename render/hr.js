...
function employees() {
  ...
  return `<div class="toolbar section-control-row section-control-row-secondary"><button class="primary" data-add-employee>+ Працівник</button></div>${rows.length ? table(rows, [clientHeading, 'Працівник', 'Посада', 'Прийнято', 'Звільнено', 'Документи'], 'hr-table') : empty('Найманих працівників поки немає.')}${filterMenu}`;
}
