...
const SECTION_HEADINGS = [
  ['overview', 'Огляд', 'Контроль ситуації'], ['dashboard', 'Картки клієнтів', 'Картки клієнтів ФОП'], ['payments', 'Оплати', 'Оплати бухгалтерських послуг'], ['taxes', 'Податки', 'Сплата податків по групах ЄП'], ['incomes', 'Доходи', 'Облік доходів і залишку ліміту'], ['reports', 'Декларації', 'Декларації по доходам'], ['combinedReports', 'Об’єднані звіти', 'Об’єднані звіти'], ['calendar', 'Календар', 'Задачі та автоматичні дедлайни'], ['activities', 'Види діяльності', 'Довідники КВЕД-2010 та NACE 2.1-UA'], ['hr', 'Кадри', 'Наймані працівники та кадрові документи'], ['inactive', 'Приховані ФОП', 'Приховані ФОП'], ['deleted', 'Видалені', 'Кошик — відновлення ФОП'], ['settings', 'Налаштування', 'Налаштування'], ['audit', 'Журнал подій', 'Історія змін і відкат'],
];
